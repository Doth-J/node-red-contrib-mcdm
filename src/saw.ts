...
interface SAWNodeConfig extends NodeRED.NodeDef{
  performance:boolean
}
...
export = function(RED:NodeRED.NodeAPI){
  ...
  function SAWNode(this:NodeRED.Node, config:SAWNodeConfig){
      ...
      this.on('input',(msg:any,send,done)=>{
        ...
        const scores = utils.sumRows(weightedMatrix),
              bestAlternativeIndex = scores.indexOf((Math.max(...scores)));
